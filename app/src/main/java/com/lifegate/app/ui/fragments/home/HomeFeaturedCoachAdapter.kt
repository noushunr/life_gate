...
import com.lifegate.app.databinding.ListHomeFeaturedCoachesBinding
...
class HomeFeaturedCoachAdapter(
    val clickListener: (HomeFeaturedCoaches) -> Unit
): RecyclerView.Adapter<HomeFeaturedCoachAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.homeFeaturedCoachTypeNameTxt.text = item.coach_type_name
        ...
        holder.binding.homeFeaturedCoachNameTxt.text = coachName
        ...
        holder.binding.homeFeaturedCoachPriceTxt.text = planStart
        loadCircleImage(holder.binding.homeFeaturedCoachImg, item.coach_photo)
    ...
    class ViewHolder(
        val binding: ListHomeFeaturedCoachesBinding
    ) : RecyclerView.ViewHolder(binding.root) {

        companion object {
            fun from(parent: ViewGroup): ViewHolder {
                val layoutInflater = LayoutInflater.from(parent.context)
                val binding = ListHomeFeaturedCoachesBinding.inflate(layoutInflater, parent, false)
